    ...
    <div className="container">
      ...
      <div className="dropdown-container">
        <div className="dropdown">
          <label htmlFor="teams">Select NBA Team:</label>
          <select id="teams" value={team} onChange={(e) => {
        ...
        <div className="dropdown">
          <label htmlFor="stat1">Select Statistic 1:</label>
          <select id="stat1" value={stat1} onChange={(e) => {
        ...
        <div className="dropdown">
          <label htmlFor="stat2">Select Statistic 2:</label>
          <select id="stat2" value={stat2} onChange={(e) => {
      ...
      <img src={imageSrc} alt="Visualization" className="placeholder-image" />
